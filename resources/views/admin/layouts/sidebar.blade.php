    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="file/create" class="menu-link">
        ...
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
                <a href="{{ route('hero.create') }}" class="menu-link">
        ...
        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-layout"></i>
            <div data-i18n="Layouts">Testimonials
          ...
          <ul class="menu-sub">
            <li class="menu-item">
                ...
                <div data-i18n="Without menu">Add Testimonials
            ...
            <li class="menu-item">
                ...
                <div data-i18n="Without navbar">Manage Testimonials
